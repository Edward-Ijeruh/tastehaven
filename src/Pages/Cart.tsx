        ...
        <div className="p-4 max-w-3xl mx-auto">
            ...
            {state.items.length === 0 ? (
                <div>
                    ...
                    <Link
                        to="/menu"
                        className="flex items-center gap-2 mt-4 px-4 py-2 bg-yellow-400 text-black rounded w-40"
                    >
                ...
                <div className="space-y-4">
                    ...
                    <div className="flex items-center justify-between">
                        ...
                        <div className="text-right">
                            <Link
                                to="/checkout"
                                className="mt-2 inline0block bg-green-500 text-white px-4 py-2 rounded"
                            >
                                Checkout
                            </Link>
                        </div>
